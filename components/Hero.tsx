        ...
        <div className='max-w-[1280px] mx-auto flex gap-[145px] relative'>    
            <div className='w-[780px] py-[90px] text-[#F0F7FF] flex flex-col gap-6'>
                ...
                <div className='flex gap-6'>
                    <button className='px-8 py-3 text-[#0033E5] bg-[#F0F7FF] font-medium text-base rounded-[200px]'>
                        Contact Us
                    </button>
                    <button className='px-8 py-3 text-[#F0F7FF] font-medium text-base rounded-[200px] border border-[#F0F7FF]'>
                        Start Free
                    </button>
                </div>
            </div>
