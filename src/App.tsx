    ...
    <>
      <div className="flex flex-col gap-2 items-center justify-center text-center h-[100vh]">
        ...
        <p className="font-bold text-xl">
          Pienteger®, on a Mission to Shape
          <span className="bg-gradient-to-r from-[#006a4e] to-[#f42a41] text-transparent bg-clip-text"> Bangladesh </span>
          into a Smart Nation.
        </p>

        <p>
          We believe, where there is a complex problem, there is a simple solution.
        </p>
